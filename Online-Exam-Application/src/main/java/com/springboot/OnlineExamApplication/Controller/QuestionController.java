package com.springboot.OnlineExamApplication.Controller;
...
import com.thekiranacademy.dao.Answer;
import com.thekiranacademy.dao.Question;
...
public class QuestionController 
{
	...
	{		
		...
		// 0 1 2   index means qno attribute value
		// 1 2 3    means question position(no)
		// assume we are at 3rd q. means index 2 			
			question=listofquestions.get((Integer)httpsession.getAttribute("qno"));				
		}		
		else
		{
